    ...
    <div class="row justify-content-center">
        ...
        @endisset
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('beritaSubmit')}}" method="POST">
                        @csrf
                        <div class="form-group row">
                        <label class="col-md-4 col-form-label text-md-left">Judul Berita</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="post_title" maxlength="50" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <label for="textarea1" class="col-md-4 col-form-label text-md-left">Keterangan Berita</label>
                            <div class="col-md-6">
                                <textarea class="form-control" id="textarea1" name="post_content" rows="5" maxlength="250"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
